...
include("./customer_area/db_connect.php");
    ...
    if($data = $stmt->fetch()){
      if(password_verify($pass, $data->password) && $data->status == 'Active'){
        ...
        echo "<script>alert('Login Success!');
          window.location.href = './customer_area/product_browsing.php';
        </script>";
      }else if(password_verify($pass, $data->password) &&$data->status == 'Blocked'){
        echo "<script>window.location.href='./customer_area/blocked.php';</script>";
      }else{
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="./customer_area/css/login.css" />
  </head>
  ...
  <body>
    ...
    <div class="container">
      <form class="form-login" action="./index.php" method="POST">
        ...
        <br> <br>
        <a href="./customer_area/register.php">Register here..</a>
      </form>
    </div>
  </body>
</html>
